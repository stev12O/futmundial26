...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function playIframe(url, container) {
    container.innerHTML = `
      <iframe src="${url}" style="width:100%;height:100%;position:absolute;top:0;left:0;border:none;background:#000;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    `;
  }
